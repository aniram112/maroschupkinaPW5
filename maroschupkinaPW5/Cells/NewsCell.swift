...
final class NewsCell: UITableViewCell {
    ...
    public func configure(with viewModel: NewsViewModel, color: UIColor){
    ...
    private func setupImageView() {
        newsImageView.image = UIImage(systemName: "multiply")?.withRenderingMode(.alwaysTemplate)
        newsImageView.tintColor = .black
